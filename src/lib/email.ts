...
function renderHtml(c: EmailContent) {
  ...
  <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:16px;padding:32px;font-family:system-ui,-apple-system,'Segoe UI',Roboto,sans-serif">
    <p style="margin:0;font-weight:700;font-size:16px;color:#1c1830"><img src="${new URL("/brand/logo-badge.png", siteConfig.url).toString()}" width="40" height="40" alt="" style="vertical-align:middle;margin-right:8px;border:0">${escapeHtml(siteConfig.name)}</p>
